...
/* Count lines in a file (can be slow for large files) */
unsigned int numberoflines(const char *name, error **err)
{
   FILE *F;
   char c;
   int n = 0;
...
/* Does not count comment lines ('#' first letter in line) */
...
/* ============================================================ *
 * The following three functions are used to read the SNLS data *
 * ============================================================ */
...
/* Reads a (fnx,fny)-matrix from a file */
