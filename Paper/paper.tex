...
\begin{equation}
\label{geodesic2D}
\pmb{\beta}_{k} = \sum_{i=1}^k\delta\pmb{\beta}_k 
\end{equation}
...
\begin{equation}
\bb{U}_{k} = \sum_{i=1}^k\delta\bb{U}_k 
\end{equation}
...
\begin{equation}
A_k = \frac{\chi_{k+1}}{\chi_{k+2}}\left(1 + \frac{\chi_{k+2}-\chi_{k+1}}{\chi_{k+1}-\chi_k}\right) \\ \\
\end{equation} 

\begin{equation}
C_k = \frac{\chi_{k+1}}{\chi_{k+2}} - 1 \\ \\
\end{equation} 
