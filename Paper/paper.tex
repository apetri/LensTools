...
Convergence Maps & \ttt{ConvergenceMap} & \specialcell{\ttt{load, smooth} \\ \ttt{powerSpectrum}, \\ \ttt{peakCounts, PDF}} & \ttt{lenstools.image.convergence}   \\ \hline 
...
Row oriented data & \specialcell{\ttt{Ensemble} \\ \ttt{(pandas.DataFrame)}} & \ttt{read, compute} & \ttt{lenstools.statistics.ensemble}  \\ \hline
...
\inputminted[linenos]{python}{Snippets/dirtree.txt}
...
\inputminted[linenos]{python}{Snippets/image.txt}
...
\inputminted[linenos]{python}{Snippets/sampling.txt}
